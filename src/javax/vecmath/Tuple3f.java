 ...
 * @param <T>
 */
public abstract class Tuple3f<T extends Tuple3f> implements java.io.Serializable {
 ...
 /**
  * Returns true if the Object t1 is of type Tuple3f and all of the data members of t1 are equal to
 ...
 public boolean epsilonEquals(Tuple3f t1, float epsilon) {
  ...
  return !different_epsilon(z, t1.z, epsilon);
 }
 ...
 /**
  * Returns a hash code value based on the data values in this object. Two different Tuple3f objects
  * with identical data values (i.e., Tuple3f.equals returns true) will return the same hash code
  ...
  * of both argument tuple is preservered (this = t1 * t2^-1).
  *
  * @param t1 the first tuple
  * @param t2 the second tuple
  * @return this for chaining
  */
 public T mulInverse(Tuple3f t1, Tuple3f t2) {
  ...
  * @return this for chaining
  */
 public T mulInverse(Tuple3f t1) {
  ...
  * @return this for chaining
  */
 public T interpolate(Tuple3f t1, Tuple3f t2, float t) {
  mix(t1, t2, t);
  return (T) this;
 }
  ...
  * @return this for chaining
  */
 public T interpolate(Tuple3f t1, float t) {
  mix(t1, t);
  return (T) this;
 }
}
