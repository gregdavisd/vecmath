...
public abstract class Tuple4f<T extends Tuple4f> implements java.io.Serializable, Cloneable {
 ...
 /**
  * Sets the value of this tuple to the specified coordinates in the array of length 4. Truncates
 ...
 /**
  * Sets the x,y,z components of this vector to the corresponding components of tuple t1, and w to
  * the argument.
  *
  * @param t1 the tuple to be copied
 ...
 /**
  * Sets the x,y,z components of this vector to the corresponding components of tuple t1, w is left
  * unchanged.
  *
  * @param t1 the tuple to be copied
  * @return this for chaining
 ...
 /**
  * Returns true if all of the data members of Tuple4f t1 are equal to the corresponding data
  * members in this Tuple4f.
  *
 ...
 /**
  * Returns true if the Object t1 is of type Tuple4f and all of the data members of t1 are equal to
 ...
 /**
  * Returns true if the L-infinite distance between this tuple and tuple t1 is less than or equal to
 ...
 /**
  * Returns a hash code value based on the data values in this object. Two different Tuple4f objects
  * with identical data values (i.e., Tuple4f.equals returns true) will return the same hash code
 ...
 /**
  * Returns the (4-space) angle in radians between this vector and the vector parameter; the return
 ...
 /**
  * Multiplies tuple t1 by the inverse of tuple t2 and places the value into this tuple. The value
  * of both argument tuple is preserved (this = t1 * t2^-1).
  *
  * @param t1 the first tuple
  * @param t2 the second tuple
  * @return this for chaining
  */
 public T mulInverse(Tuple4f t1, Tuple4f t2) {
 ...
 /**
  * Multiplies this tuple by the inverse of tuple t1 and places the value into this tuple. The value
  * of the argument tuple is preserved (this = this * q^-1).
  *
  * @param t1 the other tuple
  * @return this for chaining
  */
 public T mulInverse(Tuple4f t1) {
