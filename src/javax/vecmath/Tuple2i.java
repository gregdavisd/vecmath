 ...
 * @since vecmath 1.4
 */
public abstract class Tuple2i<T extends Tuple2i> implements java.io.Serializable, Cloneable {
  ...
  * @return t for chaining
  */
 public <S extends Tuple2i> S get(S t) {
  t.x = this.x;
  t.y = this.y;
  return (S) t;
 }
  ...
  * @return this for chaining
  */
 public T add(Tuple2i t1, Tuple2i t2) {
  this.x = t1.x + t2.x;
  this.y = t1.y + t2.y;
  return (T) this;
 }
  ...
  * @return this for chaining
  */
 public T sub(Tuple2i t1, Tuple2i t2) {
  this.x = t1.x - t2.x;
  this.y = t1.y - t2.y;
  return (T) this;
 }
  ...
  * @return this for chaining
  */
 public T scale(int s, Tuple2i t1) {
  this.x = s * t1.x;
  this.y = s * t1.y;
  return (T) this;
 }
  ...
  * @return this for chaining
  */
 public T scaleAdd(int s, Tuple2i t1, Tuple2i t2) {
  this.x = s * t1.x + t2.x;
  this.y = s * t1.y + t2.y;
  return (T) this;
 }
  ...
  * @return this for chaining
  */
 public T scaleAdd(int s, Tuple2i t1) {
 ...
 /**
  * Returns true if the Object t1 is of type Tuple2i and all of the data members of t1 are equal to
  * the corresponding data members in this Tuple2i.
  *
 ...
 /**
  * Returns a hash code value based on the data values in this object. Two different Tuple2i objects
  * with identical data values (i.e., Tuple2i.equals returns true) will return the same hash code
  ...
  * @return this for chaining
  */
 public T clamp(int min, int max, Tuple2i t) {
  if (t.x > max) {
   x = max;
  } else if (t.x < min) {
   x = min;
  ...
  * @return this for chaining
  */
 public T clampMin(int min, Tuple2i t) {
  if (t.x < min) {
   x = min;
  } else {
   x = t.x;
  ...
  * @return this for chaining
  */
 public T clampMax(int max, Tuple2i t) {
  if (t.x > max) {
   x = max;
  } else {
   x = t.x;
