...
/**
 * A four-element color represented by single precision floating point x, y, z, and w values. The x,
 * y, z, and w values represent the red, blue, green, and alpha color values, respectively. Color
 * and alpha components should be in the range [0.0, 1.0].
 * <p>
 * Java 3D assumes that a linear (gamma-corrected) visual is used for all colors.
 *
 */
public class Color4f extends Tuple4f<Color4f> implements java.io.Serializable {
