...
public class IntPointer {
 ...
 /**
  * Construct a IntPointer object that points to the value in the specified array at the specified
  * index
  *
  * @param array
  * @param index
  */
 public IntPointer(int[] array, int index) {
  this.array = array;
  this.offset = index;
 }
 ...
 /**
  * Construct a IntPointer object from another IntPointer object with a shifted base index
  *
  * @param base pointer to a value
  * @param delta shift the location the new object points to by delta indices relative to base
  * pointer
  */
 public IntPointer(IntPointer base, int delta) {
  array = base.array;
  offset = base.offset + delta;
 }

 /**
  * Construct a IntPointer object by copying another IntPointer object
  *
  * @param base pointer to a value
  */
 public IntPointer(IntPointer base) {
  array = base.array;
  offset = base.offset;
 }
  ...
  */
 public void set(int delta, int value) {
  ...
  */
 public void read(int[] dest, int length) {
  ...
  */
 public void copy(IntPointer source, int length) {
  ...
  */
 public boolean is_pointing_to(int[] array) {
  ...
  * to at all.
  */
 public boolean is_pointing_into(int[] array) {
