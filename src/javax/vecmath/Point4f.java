 ...
 *
 */
public class Point4f extends Tuple4f<Tuple4f> implements java.io.Serializable {
 ...
 /**
  * Constructs and initializes a Point4f from the specified Tuple3f. The x,y,z components of this
  * point are set to the corresponding components of tuple t1. The w component of this point is set
  * to 1.
  *
  ...
  * to: abs(x1-x2) + abs(y1-y2) + abs(z1-z2) + abs(w1-w2).
  *
  ...
  * equal to MAX[abs(x1-x2), abs(y1-y2), abs(z1-z2), abs(w1-w2)].
  *
  * @param p1 the other point
 ...
 /**
  * Multiplies each of the x,y,z components of the Point4f parameter by 1/w, places the projected
  * values into this point, and places a 1 as the w parameter of this point.
  *
