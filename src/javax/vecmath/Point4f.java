...
public class Point4f extends Tuple4f implements java.io.Serializable {
	...
	/**
	 * Constructs and initializes a Point4f from the specified Tuple3f. The x,y,z components of this point are set to the
	 * corresponding components of tuple t1. The w component of this point is set to 1.
	 *
