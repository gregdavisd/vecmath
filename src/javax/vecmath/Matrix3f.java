...
public class Matrix3f<T extends Matrix3f> implements java.io.Serializable  {
 ...
 /**
  * Initializes a Matrix3f from the specified nine values.
  *
  * @param m00 the [0][0] element
  * @param m01 the [0][1] element
  * @param m02 the [0][2] element
  ...
  * @return
  */
 public T set(float m00, float m01, float m02,
  float m10, float m11, float m12,
  float m20, float m21, float m22) {
  this.m00 = m00;
  this.m01 = m01;
  ...
  * SVD) and multiplying by the new scale.
  *
  ...
  */
 public <S extends Tuple3f> S getRow(int row, S v) {
  switch (row) {
   case 0:
    v.x = m00;
    v.y = m01;
  ...
  * @return v for chaining
  */
 public <S extends Tuple3f> S getColumn(int column, S v) {
  switch (column) {
   case 0:
    v.x = m00;
    v.y = m10;
  ...
  * @return this for chaining
  */
 public T setRow(int row, float x, float y, float z) {
  switch (row) {
   case 0:
    m00 = x;
    m01 = y;
  ...
  * @return this for chaining
  */
 public T setRow(int row, Tuple3f v) {
  switch (row) {
   case 0:
    m00 = v.x;
    m01 = v.y;
  ...
  * @return this for chaining
  */
 public T setColumn(int column, float x, float y, float z) {
  switch (column) {
   case 0:
    m00 = x;
    m10 = y;
  ...
  * @return this for chaining
  */
 public T setColumn(int column, Tuple3f v) {
  switch (column) {
   case 0:
    m00 = v.x;
    m10 = v.y;
 ...
 /**
  * Performs an SVD normalization of this matrix to calculate and return the non-uniform scale
  * factor in a tuple.
  *
  *
  * @param <S>
  ...
  * @return this for chaining
  */
 public T add(Matrix3f m1, Matrix3f m2) {
  m00 = m1.m00 + m2.m00;
  m01 = m1.m01 + m2.m01;
  m02 = m1.m02 + m2.m02;
  m10 = m1.m10 + m2.m10;
  ...
  * @return this for chaining
  */
 public T sub(Matrix3f m1, Matrix3f m2) {
  m00 = m1.m00 - m2.m00;
  m01 = m1.m01 - m2.m01;
  m02 = m1.m02 - m2.m02;
  m10 = m1.m10 - m2.m10;
  ...
  * @return this for chaining
  */
 public T transpose(Matrix3f m1) {
  set(m1);
  transpose();
  return (T) this;
 }
 ...
 /**
  * Sets the value of this matrix to the matrix conversion of the (single precision) quaternion
  * argument.
  *
  ...
  * @return this for chaining
  */
 public T mul(float scalar, Matrix3f m1) {
  m00 = scalar * m1.m00;
  m01 = scalar * m1.m01;
  m02 = scalar * m1.m02;
  m10 = scalar * m1.m10;
  ...
  * @return this for chaining
  */
 public T mul(Matrix3f m1, Matrix3f m2) {
  ...
  * @return this for chaining
  */
 public T mulNormalize(Matrix3f m1) {
  ...
  * @return this for chaining
  */
 public T mulNormalize(Matrix3f m1, Matrix3f m2) {
  Matrix3f tmp = new Matrix3f();
  tmp.mul(m1, m2);
  getScaleRotate(tmp, new Vector3f(), this);
  return (T) this;
  ...
  * @return this for chaining
  */
 public T mulTransposeBoth(Matrix3f m1, Matrix3f m2) {
  ...
  * @return this for chaining
  */
 public T mulTransposeRight(Matrix3f m1, Matrix3f m2) {
  ...
  * @return this for chaining
  */
 public T mulTransposeLeft(Matrix3f m1, Matrix3f m2) {
 ...
 /**
  * Perform singular value decomposition normalization of matrix m1 and place the normalized values
  * into this.
  *
  * @param m1 the matrix values to be normalized
  * @return this for chaining
  */
 public T normalize(Matrix3f m1) {
 ...
 /**
  * Returns true if the Object o1 is of type Matrix3f and all of the data members of o1 are equal to
  * the corresponding data members in this Matrix3f.
  *
 ...
 /**
  * Returns a hash code value based on the data values in this object. Two different Matrix3f
  * objects with identical data values (i.e., Matrix3f.equals returns true) will return the same
  ...
  */
 public <S extends Tuple3f> S transform(S t) {
  ...
  */
 public <T extends Tuple3f> T transform(Tuple3f t1, Tuple3f t2) {
  ...
  * @return this for chaining
  */
 public T setDiagonal(Tuple3f v) {
  m00 = v.x;
  m11 = v.y;
  m22 = v.z;
  return (T) this;
  ...
  * @return this for chaining
  */
 public T mul(Matrix3f m1, Tuple3f s) {
  m00 = m1.m00 * s.x;
  m01 = m1.m01 * s.y;
  m02 = m1.m02 * s.z;
  m10 = m1.m10 * s.x;
