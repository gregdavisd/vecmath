...
public class Vector4f extends Tuple4f implements java.io.Serializable {
	...
	/**
	 * Constructs and initializes a Vector4f from the specified Tuple3f. The x,y,z components of this vector are set to the
	 * corresponding components of tuple t1. The w component of this vector is set to 0.
	 *
