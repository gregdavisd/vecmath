 ...
 * @param <T>
 */
public abstract class Tuple2f<T extends Tuple2f> implements java.io.Serializable {
 ...
 /**
  * Returns true if the Object t1 is of type Tuple2f and all of the data members of t1 are equal to
 ...
 /**
  * Linearly interpolates between tuples this and t1 and places the result into this tuple: this =
 ...
 /**
  * Calculate the cross product of this vector and another. In two dimensions the cross product is
 ...
 /**
  * Returns a hash code value based on the data values in this object. Two different Tuple2f objects
  * with identical data values (i.e., Tuple2f.equals returns true) will return the same hash code
 ...
 /**
  * Returns the angle in radians between this vector and the vector parameter; the return value is
  ...
  * @return this for chaining
  */
 public T mulInverse(Tuple2f t1, Tuple2f t2) {
  ...
  * @return this for chaining
  */
 public T mulInverse(Tuple2f t1) {
